...
function mod:LoadAssetAsync(url:string,assetid:number,loadSettings,parent:Instance?,position:Vector3,ver:number):Model
    ...
    if self.isInitialized then
        ...
        local function fetchAndDecode()
            ...
            local full_url=url.."/"..assetid_string.."?placeId="..game.PlaceId;
            if ver then
